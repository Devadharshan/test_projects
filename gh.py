...
with open(sql_output_file, "w", encoding="utf-8") as f:  # write SQL file
    for file_name in xls_files:
        ...
        try:
            # Read HTML disguised as Excel with latin1 encoding
            ...
            # Find all columns containing 'code'
            ...
            if not codes:
                logging.warning(f"⚠️ No codes found in file {file_name}. Skipping.")
                continue
            ...
            for idx, q in enumerate(queries, start=1):
                try:
                    ...
                    # Prepare bind placeholders for execution
