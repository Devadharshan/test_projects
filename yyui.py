...
def fetch_incidents(conn, period):
    ...
    if period == "Last_7_days":
        start_date = end_date - timedelta(days=end_date.weekday())  # From Sunday to today
        ...
        start_date = datetime(end_date.year, 1, 1)  # From January 1st to today
...
def format_date_to_month_year(date):
    return date.strftime('%b-%Y')  # Format as Jan-2024
